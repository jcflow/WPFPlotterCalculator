...
namespace Calculator.ViewModels
{
    ...
    public class DelegateCommand : ICommand
    {
        ...
        ///     Constructor
        /// </summary>
        public DelegateCommand(Action executeCommandMethod, Func<bool> canExecuteCommandMethod, bool isCommandAutomaticRequeryDisabled)
        {
            ...
            executeMethod = executeCommandMethod;
            canExecuteMethod = canExecuteCommandMethod;
            isAutomaticRequeryDisabled = isCommandAutomaticRequeryDisabled;
        }
    ...
    public class DelegateCommand<T> : ICommand
    {
        ...
        /// Constructor
        /// </summary>
        public DelegateCommand(Action<T> executeCommandMethod, Func<T, bool> canExecuteCommandMethod,
            bool isCommandAutomaticRequeryDisabled)
        {
            if (executeCommandMethod == null)
            {
                throw new ArgumentNullException("executeMethod");
